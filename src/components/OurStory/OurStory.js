                ...
                <div className="wrapper__main">
                    <div className="ourstory__container">
                        ...
                        <div className="ourstory__content">
                            ...
                            <p className='ourstory__description'>This is Photoshop's version of Lorem Ipsum. Proin
                            ...
                            <p className="ourstory__description">Morbi accumsan ipsum velit. Nam nec tellus a odio
