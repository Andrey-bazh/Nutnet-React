    ...
    return (
        <section className="team" id="team">
            <div className="team__container">
                <TitleComponent className='title__team' headerText='MEET OUR AMAZING TEAM'
                                description='Lorem ipsum dolor sit amet proin gravida nibh vel velit'/>
                ...
                <span className="team__join">Become part of our dream team, let’s join us !</span>
